    ...
    <div >
        ...
        <div className={`${styles.flexContainer} `}>
            <div id={styles.leftContainer}>
                <div className={`${styles.card} ${styles.br} ${styles.animate}`} data-testid="task-content-shimmer-card">
                </div>

                <div className={`${styles.card} ${styles.br} ${styles.customCardHeight} ${styles.animate}`} data-testid="task-content-shimmer-card">
                </div>

                <div className={`${styles.card} ${styles.br}`} data-testid="task-content-shimmer-card">
